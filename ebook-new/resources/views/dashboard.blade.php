                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            <a href="{{ route('sliderCategories.index') }}"
                                class="hover:underline text-gray-500 hover:text-[#BA8A70] text-xl">
                                <i class="fa-solid fa-layer-group"> <span>Slider Categories
                                        ({{$sliderCategories}})</span></i>
                            </a>
                        </div>
                    </div>
